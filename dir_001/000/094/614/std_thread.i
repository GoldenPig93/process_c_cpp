# 1 "/home/kevin/Desktop/AI-Vulnerability/test/version3/dir_001/000/094/614/std_thread.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/kevin/Desktop/AI-Vulnerability/test/version3/dir_001/000/094/614/std_thread.c" 2
...
# 7 "/home/kevin/Desktop/AI-Vulnerability/test/version3/dir_001/000/094/614/std_thread.c" 2
...
# 11 "/home/kevin/Desktop/AI-Vulnerability/test/version3/dir_001/000/094/614/std_thread.c" 2
...
# 13 "/home/kevin/Desktop/AI-Vulnerability/test/version3/dir_001/000/094/614/std_thread.c" 2
...
# 31 "/home/kevin/Desktop/AI-Vulnerability/test/version3/dir_001/000/094/614/std_thread.c"
...
int stdThreadCreate(stdThreadRoutine start, void *args, stdThread *thread)
{
    ...
    *thread = ((void*)0);
    ...
    my_thread->args = args;
# 75 "/home/kevin/Desktop/AI-Vulnerability/test/version3/dir_001/000/094/614/std_thread.c"
    if (0 != pthread_create(&handle, ((void*)0), internal_start, my_thread)) {
        free(my_thread);
        return 0;
    }
...
int stdThreadLockCreate(stdThreadLock *lock)
{
    stdThreadLock my_lock = ((void*)0);

    *lock = ((void*)0);

    my_lock = (stdThreadLock)malloc(sizeof(*my_lock));
    if (my_lock == ((void*)0)) return 0;
# 151 "/home/kevin/Desktop/AI-Vulnerability/test/version3/dir_001/000/094/614/std_thread.c"
    if (0 != pthread_mutex_init(&my_lock->mutex, ((void*)0))) {
        free(lock);
        return 0;
    }
...
void stdThreadLockAcquire(stdThreadLock lock)
{
# 185 "/home/kevin/Desktop/AI-Vulnerability/test/version3/dir_001/000/094/614/std_thread.c"
